...
public class CategoryProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSort.setOnClickListener(v -> {
            SortByDialogFragment dialog = new SortByDialogFragment(option -> {
                ...
                fetchProductsByCategory(currentSortOption);
            });
            ...
            if (product.isFavorite()) {
                apiManager.removeFavorite(userId, product.getProductID(), new Callback<Void>() {
                    ...
                    public void onResponse(Call<Void> call, Response<Void> response) {
                        ...
                        Toast.makeText(CategoryProductActivity.this, "Đã xóa khỏi yêu thích", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onFailure(Call<Void> call, Throwable t) {
                        Toast.makeText(CategoryProductActivity.this, "Lỗi khi xóa yêu thích", Toast.LENGTH_SHORT).show();
                    }
                });
            } else {
                apiManager.addFavorite(userId, product.getProductID(), new Callback<Void>() {
                    ...
                    public void onResponse(Call<Void> call, Response<Void> response) {
                        ...
                        productAdapter.notifyItemChanged(position);
                        Toast.makeText(CategoryProductActivity.this, "Đã thêm vào yêu thích", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onFailure(Call<Void> call, Throwable t) {
                        Toast.makeText(CategoryProductActivity.this, "Lỗi khi thêm yêu thích", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    private void fetchProductsByCategory(String sortOption) {
        apiManager.getProductsByCategory(categoryId, userId, sortOption, new Callback<List<ProductResponse>>() {
            @Override
            public void onResponse(Call<List<ProductResponse>> call, Response<List<ProductResponse>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    productList.clear();
                    ...
                    Toast.makeText(CategoryProductActivity.this, "Không thể tải sản phẩm", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<List<ProductResponse>> call, Throwable t) {
                Toast.makeText(CategoryProductActivity.this, "Lỗi kết nối", Toast.LENGTH_SHORT).show();
            }
        });
    }
}